...
SECRET_KEY = 'django-insecure-0@sqs(l1!2mt5=op#v1^@cal_09=#57k#_dl8ir@68j5=b6jg*'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'dairy/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'dairy/static'),  # Path to static files
]
...
LOGIN_URL = '/admin/login/'  # Redirects to admin login
